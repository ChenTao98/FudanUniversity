...
import com.app.zpvoh.imgcluster.sqlUtils.JDBCUtils;
...
public class SignUpActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameTextView=(EditText) findViewById(R.id.signup_name);
    ...
    private void attemptLogin() {
        ...
        if(TextUtils.isEmpty(name)){
            nameTextView.setError(getString(R.string.siup_name_name_empty));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            boolean result=SqlDao.signUp(connection,mEmail,mName,mPassword);
            try {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mEmailView.setError(getString(R.string.error_mail_exist));
